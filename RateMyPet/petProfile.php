...
<body>
    ...
    <div class="content">
        ...
        if ($_SESSION['user']->rol() == "admin") {
            ...
            echo '<form method="POST" action="include/deleteAccount.php">
                    ...
                    <input type="submit" class="button-create" value="Delete Pet">
                </form>';
            echo '<hr>';
        }
        ?>
            ...
            if ($verified) {
                ...
                if ($myPosts->num_rows > 0) {
                    ...
                    while ($row = $myPosts->fetch_assoc()) {
                        ...
                        echo '<a href="postMascota.php?id=' . $post->idPost() . '"><img src="' . $post->getImageSrc() . '" style="width:100%" class="hover-opacity"></a>
    ...
    <script src="js/slickSettingsPosts.js"></script>
</body>
